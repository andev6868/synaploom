...
const namespaces = new Map([
  ...
  ['workspace-presentation.schema.json', 'WorkspacePresentationSchema'],
]);
const chunks = [];
...
export type UpdateWorkspacePresentationPayload = WorkspacePresentationSchema.UpdateWorkspacePresentationPayload;
