...
expect(
  resolveProgressionAction({ type: 'VIEW_COURSE_SUMMARY', courseId: 'perf' }, navigation),
...
```ts
['chapter-assessment', courseId, chapterId, assessmentId][('course-navigation', courseId)][
  'course'
];
```
