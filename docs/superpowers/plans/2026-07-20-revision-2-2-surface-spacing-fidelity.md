...
- [ ] **Step 1: Add RED unit and browser geometry assertions**
...
- [ ] **Step 3: Implement geometry and token changes**
...
- [ ] **Step 1: Add RED anatomy and geometry assertions**
...
- [ ] **Step 2: Confirm RED on current spacing**
...
- [ ] **Step 1: Add RED class/geometry assertions**
...
- [ ] **Step 3: Implement border and spacing hierarchy**
...
- [ ] **Step 1: Add RED dock geometry assertions**
...
- [ ] **Step 2: Confirm RED against current edge-to-edge dock**

Run the focused assistant test and visual runtime spec without updating snapshots.

- [ ] **Step 3: Implement dock inset and update six baselines**
